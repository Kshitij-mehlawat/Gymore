...
def init_db():
    ...
    add_column_if_missing(cursor, "trainer_profiles", "preferred_course_type", "preferred_course_type VARCHAR(100) NULL")
    add_column_if_missing(cursor, "trainer_profiles", "average_fee", "average_fee VARCHAR(100) NULL")
    add_column_if_missing(cursor, "trainer_profiles", "teaching_summary", "teaching_summary TEXT NULL")
    add_column_if_missing(cursor, "trainer_profiles", "latest_request_id", "latest_request_id INT NULL")
    add_column_if_missing(cursor, "trainer_profiles", "review_note", "review_note TEXT NULL")
    add_column_if_missing(cursor, "trainer_profiles", "reviewed_at", "reviewed_at DATETIME NULL")
    add_column_if_missing(cursor, "trainer_profiles", "updated_at", "updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP")

    add_column_if_missing(cursor, "trainer_verification_requests", "average_fee", "average_fee VARCHAR(100) NULL")

    add_column_if_missing(cursor, "equipment_orders", "full_name", "full_name VARCHAR(255) NULL")
    add_column_if_missing(cursor, "equipment_orders", "address", "address TEXT NULL")
    add_column_if_missing(cursor, "equipment_orders", "pincode", "pincode VARCHAR(20) NULL")
    add_column_if_missing(cursor, "equipment_orders", "phone", "phone VARCHAR(20) NULL")
    add_column_if_missing(cursor, "equipment_orders", "payment_status", "payment_status VARCHAR(50) DEFAULT 'completed'")
